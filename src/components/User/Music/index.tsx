            ...
            <div className={"my-music-item"}>
              <div className={"my-music-layer"}>
                <div className={"my-music-type"}>
                  ...
                  <span className={"my-music-layer-text"}>我喜欢的音乐</span>
                </div>
                <div className={"my-music-description"}>
                  <i className={""} />
                  <span className={"my-music-description-text"}>心动模式</span>
                </div>
              </div>
            </div>
            <div className={"my-music-item"}>
              <div className={"my-music-layer"}>
                <div className={"my-music-type"}>
                  ...
                  <span className={"my-music-layer-text"}>私人FM</span>
                </div>
                <div className={"my-music-fm-description"}>
                  <span className={"my-music-description-text"}>
                    最懂你的推荐
                  </span>
                </div>
              </div>
