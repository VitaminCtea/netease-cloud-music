...
import {
  normalPlayerDefaultStyle,
  normalPlayerTransitionStyle,
  DURATION,
  miniPlayerDefaultStyle,
} from "common/ts/playerAnimation";
import "./index.sass";
...
export default function Player({
  ...
  const progressTouchStart = useCallback((e: any) => {
    ...
    touch.current.ballNode =
      touch.current.ballNode || getSelector(".normal-player-progress-ball");
  ...
  const miniPlayerControlsPlay = useCallback(
    (audioRef: Ref<HTMLAudioElement>) => async (e: React.SyntheticEvent) => {
      e.stopPropagation();
    ...
    (audioRef: Ref<HTMLAudioElement>) => async (e: React.SyntheticEvent) => {
      ...
      switch (target.className) {
        ...
        case "icon-player-play":
          const className = playing ? "icon-player-play" : "icon-player-pause";
  ...
  return (
    <div className={"player-container"}>
      <Transition
        ...
        unmountOnExit={true}
      >
        {(state: keyof typeof normalPlayerTransitionStyle) => (
          <div
            className={"normal-player"}
            style={{
              ...normalPlayerDefaultStyle,
              ...normalPlayerTransitionStyle[state],
            }}
          >
            <div
            ...
            <div className={"normal-player-header"}>
              <div className={"normal-player-header-left"}>
                <i className={"icon-back"} onClick={setFullScreen} />
            ...
            <div className={"normal-player-bottom-container"}>
              ...
              <div className={"normal-player-progress"}>
                ...
                <div
                  className={"normal-player-progress-background"}
                  onClick={setSongSeeked}
                >
                  <div
                    className={"normal-player-progress-percent"}
      ...
      >
        {(state: keyof typeof transitionStyle) => {
          const { defaultStyle, transitionStyle } = miniPlayerDefaultStyle(
            `${miniPlayerHeight}px`,
            0
          );
          return (
            ...
            >
              ...
              <div className={"mini-player-controls-icon"}>
                <ProgressRing
                  ...
                  miniPlayerControlsPlay={miniPlayerControlsPlay(audioRef)}
                >
