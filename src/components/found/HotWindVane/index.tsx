              ...
              {topList.map((data: any, index: number) => (
                ...
                >
                  <div className={"hotWindVane-item-title-container"}>
                    ...
                    <span className={"hotWindVane-item-title-description"}>
                      {data.name}
                    </span>
                  </div>
                  <ul className={"hotWindVane-list"}>
                    {data.tracks.map((track: Data, itemIndex: number) => (
                      <li
                        className={"hotWindVane-list-item"}
                        key={itemIndex + 10}
                      >
                        ...
                        <div className={"hotWindVane-list-item-details"}>
                          <div className={"hotWindVane-serialNumber-container"}>
                            <span className={"hotWindVane-item-serialNumber"}>
                              {itemIndex + 1}
                            </span>
                          </div>
                          <div className={"hotWindVane-item-text"}>
                            ...
                            <span className={"hotWindVane-horizontal-line"}>
                              -
                            </span>
                            <span
                              className={"hotWindVane-item-singer"}
                            >{`${track.ar[0].name}`}</span>
                          </div>
                        </div>
                        <div
                          className={"hotWindVane-item-song-state-container"}
                        >
                          <span className={"hotWindVane-item-song-state"}>
                            新
                          </span>
                        </div>
                      </li>
